...
public class HitAutoSmithingTableBehavior implements IAnvilBehavior {
    @Override
    public boolean handle(Level level, BlockPos hitBlockPos, BlockState hitBlockState, float fallDistance, AnvilFallOnLandEvent event) {
        ...
        AutoSmithingTableBlockEntity blockEntity = (AutoSmithingTableBlockEntity) level.getBlockEntity(hitBlockPos);
